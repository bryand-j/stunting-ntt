...
<?=view('admin/indikator/subheader'); ?>
...
//tampil tabel
function getTable() {
	Crud.getHtml('/admin/IndikatorPencegahan/table',(result)=> {
...
// tampil form add
  ...
  $("#add-new").click(function(e) {
  	Crud.getHtml('/admin/IndikatorPencegahan/formAdd',(result)=> {
  		...
  		$('#add-form').submit( function(event) {
				...
				KTUtil.btnWait(btn);
				Crud.post('/admin/IndikatorPencegahan/save',new FormData(this),(result)=>{
...
function hapus(id) {
	del('/admin/IndikatorPencegahan/delete',id,()=>{
		getTable();
	})
}
...
function formEdit(id,select) {
	Crud.getHtml('/admin/IndikatorPencegahan/formEdit/'+id,(result)=> {
  	$('#modal-place').html(result);
  	load();
  	$("#bry-modal").modal("show");
  	...
  	$('#edit-form').submit(function(event) {
				...
				Crud.post('/admin/IndikatorPencegahan/update',new FormData(this),(result)=>{
					Dialog.toast(result.type,result.message);
					KTUtil.btnRelease(btn);
					$("#bry-modal").modal("hide");
					getTable();
