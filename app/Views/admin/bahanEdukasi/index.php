...
<?=view('admin/bahanEdukasi/subheader'); ?>
...
//tampil tabel
function getTable() {
	Crud.getHtml('/admin/BahanEdukasi/table',(result)=> {
...
// tampil form add
  ...
  $("#add-new").click(function(e) {
  	Crud.getHtml('/admin/BahanEdukasi/formAdd',(result)=> {
  		...
  		$('#add-form').submit( function(event) {
				...
				KTUtil.btnWait(btn);
				Crud.post('/admin/BahanEdukasi/save',new FormData(this),(result)=>{
...
function hapus(id) {
	del('/admin/BahanEdukasi/delete',id,()=>{
		getTable();
	})
}
...
function formEdit(id,select) {
	Crud.getHtml('/admin/BahanEdukasi/formEdit/'+id,(result)=> {
  	$('#modal-place').html(result);
  	load();
  	$("#bry-modal").modal("show");
  	...
  	$('#edit-form').submit(function(event) {
				...
				Crud.post('/admin/BahanEdukasi/update',new FormData(this),(result)=>{
					Dialog.toast(result.type,result.message);
					KTUtil.btnRelease(btn);
					$("#bry-modal").modal("hide");
					getTable();
