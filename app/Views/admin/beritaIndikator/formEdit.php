  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content" >
      ...
      <form id="edit-form" action="" method="_post">
      	<input type="hidden" name="idberita" value="<?=$data['idberita']?>">
	      <div class="modal-body sc" style="height: 500px; overflow-y: auto;">
	      	<div class="row">
					  ...
					  <div class="form-group col-md-6">
					    ...
					    <input type="date" value="<?=$data['tgpost']?>" name="tgpost" class="form-control"  placeholder="Tanggal Post" required="" />
					  </div>
					  <div class="form-group col-md-6">
					  ...
					  <div class="form-group col-12">
							...
							<div>
							<div class="image-input image-input-empty image-input-outline" id="kt_image_5" style="background-image: url(/thumbnail_berita_indikator/<?=$data['thumbnail_berita']?>); width: 100%;">
