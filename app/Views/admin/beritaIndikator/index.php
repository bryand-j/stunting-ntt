...
<?=view('admin/BeritaIndikator/subheader'); ?>
...
//tampil tabel
function getTable() {
	Crud.getHtml('/admin/BeritaIndikator/table',(result)=> {
...
// tampil form add
  ...
  $("#add-new").click(function(e) {
  	Crud.getHtml('/admin/BeritaIndikator/formAdd',(result)=> {
  		...
  		$('#add-form').submit( function(event) {
				...
				KTUtil.btnWait(btn);
				Crud.post('/admin/BeritaIndikator/save',new FormData(this),(result)=>{
...
function hapus(id) {
	del('/admin/BeritaIndikator/delete',id,()=>{
		getTable();
	})
}
...
function formEdit(id,select) {
	Crud.getHtml('/admin/BeritaIndikator/formEdit/'+id,(result)=> {
  	$('#modal-place').html(result);
  	load();
  	$("#bry-modal").modal("show");
  	...
  	$('#edit-form').submit(function(event) {
				...
				Crud.post('/admin/BeritaIndikator/update',new FormData(this),(result)=>{
					Dialog.toast(result.type,result.message);
					KTUtil.btnRelease(btn);
					$("#bry-modal").modal("hide");
					getTable();
