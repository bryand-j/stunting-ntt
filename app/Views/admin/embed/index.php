...
//tampil tabel
function getTable() {
	Crud.getHtml('/admin/Embed/table',(result)=> {
...
// tampil form add
  ...
  $("#add-new").click(function(e) {
  	Crud.getHtml('/admin/Embed/formAdd',(result)=> {
  		...
  		$('#add-form').submit(function(event) {
				...
				Crud.post('/admin/Embed/save',new FormData(this),(result)=>{
...
function formEdit(id) {
	Crud.getHtml('/admin/Embed/formEdit/'+id,(result)=> {
  	$('#modal-place').html(result);
  	$("#bry-modal").modal("show");
  	...
  	$('#edit-form').submit(function(event) {
				...
				Crud.post('/admin/Embed/update',new FormData(this),(result)=>{
					Dialog.toast(result.type,result.message);
					KTUtil.btnRelease(btn);
					$("#bry-modal").modal("hide");
					getTable();
