...
//tampil tabel
function getTable() {
	Crud.getHtml('/admin/AksiKonvergensi/table',(result)=> {
...
// tampil form add
  ...
  $("#add-new").click(function(e) {
  	Crud.getHtml('/admin/AksiKonvergensi/formAdd',(result)=> {
  		...
  		$('#add-form').submit( function(event) {
				...
				KTUtil.btnWait(btn);
				Crud.post('/admin/AksiKonvergensi/save',new FormData(this),(result)=>{
...
function hapus(id) {
	del('/admin/AksiKonvergensi/delete',id,()=>{
		getTable();
	})
}
...
function formEdit(id,select) {
	Crud.getHtml('/admin/AksiKonvergensi/formEdit/'+id,(result)=> {
  	$('#modal-place').html(result);
  	load();
  	$("#bry-modal").modal("show");
  	...
  	$('#edit-form').submit(function(event) {
				...
				Crud.post('/admin/AksiKonvergensi/update',new FormData(this),(result)=>{
					Dialog.toast(result.type,result.message);
					KTUtil.btnRelease(btn);
					$("#bry-modal").modal("hide");
					getTable();
