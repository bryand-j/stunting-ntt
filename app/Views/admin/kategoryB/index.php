...
<?=view('admin/kategoryB/subheader'); ?>
...
//tampil tabel
function getTable() {
	Crud.getHtml('/admin/KategoriBerita/table',(result)=> {
...
// tampil form add
  ...
  $("#add-new").click(function(e) {
  	Crud.getHtml('/admin/KategoriBerita/formAdd',(result)=> {
  		...
  		$('#add-form').submit(function(event) {
				...
				Crud.post('/admin/KategoriBerita/save',new FormData(this),(result)=>{
...
function hapus(id) {
	del('/admin/KategoriBerita/delete',id,()=>{
		getTable();
	})
}
...
function formEdit(id) {
	Crud.getHtml('/admin/KategoriBerita/formEdit/'+id,(result)=> {
  	$('#modal-place').html(result);
  	$("#bry-modal").modal("show");
  	...
  	$('#edit-form').submit(function(event) {
				...
				Crud.post('/admin/KategoriBerita/update',new FormData(this),(result)=>{
					Dialog.toast(result.type,result.message);
					KTUtil.btnRelease(btn);
					$("#bry-modal").modal("hide");
					getTable();
