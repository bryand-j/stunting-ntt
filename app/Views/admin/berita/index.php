...
//tampil tabel
function getTable() {
	Crud.getHtml('/admin/Berita/table',(result)=> {
...
// tampil form add
  ...
  $("#add-new").click(function(e) {
  	Crud.getHtml('/admin/Berita/formAdd',(result)=> {
  		...
  		$('#add-form').submit( function(event) {
				...
				KTUtil.btnWait(btn);
				Crud.post('/admin/Berita/save',new FormData(this),(result)=>{
...
function formEdit(id,select) {
	Crud.getHtml('/admin/Berita/formEdit/'+id,(result)=> {
  	$('#modal-place').html(result);
  	load();
  	$("#bry-modal").modal("show");
  	...
  	$('#edit-form').submit(function(event) {
				...
				Crud.post('/admin/Berita/update',new FormData(this),(result)=>{
					Dialog.toast(result.type,result.message);
					KTUtil.btnRelease(btn);
					$("#bry-modal").modal("hide");
					getTable();
